[![Build Status](https://travis-ci.org/hoserdude/spring-boot-sample-yaml-config.svg?branch=master)](https://travis-ci.org/hoserdude/spring-boot-sample-yaml-config)
